...
thread_count = 10
theme_name = 'Bread'
out_folder_path = '/Users/Detonavomek/Documents/Python_projects/Django/ditbog/ditbog/media/script_res/'
...
if not os.path.exists(out_folder_path+out_folder_name+engineID+'/'): 
	os.makedirs(out_folder_path+out_folder_name+engineID+'/')
