...
if not os.path.exists(out_folder_path+out_folder_name+'/'): os.makedirs(out_folder_path+out_folder_name+'/')

downloadTheme(theme_name, out_folder_path+out_folder_name+'/')
zipdir(out_folder_path+out_folder_name+'/', out_folder_path+theme_name.lower()+'.zip')
shutil.rmtree(out_folder_path+out_folder_name+'/')